    ...
    <div className="space-y-9">
      ...
      <div>
        ...
        <input
          ...
          className="h-14 w-full rounded-2xl border border-navy/25 bg-cream px-4 font-nunito text-base font-medium text-navy outline-none focus:border-flockie-blue"
          placeholder="…"
        />
