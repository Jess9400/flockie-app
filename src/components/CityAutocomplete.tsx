    ...
    <div ref={wrapperRef} className="relative">
      ...
      {showDropdown && (
        <ul
          id={listboxId}
          role="listbox"
          className="absolute left-0 right-0 top-full z-20 mt-1.5 max-h-64 overflow-y-auto rounded-2xl border border-ink/15 bg-white py-1 shadow-[0_4px_16px_rgba(10,37,69,0.14)]"
        >
