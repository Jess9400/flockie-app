...
| `recommended_vibes`, `invite_city_fallback`, `vibe_directory` (+club_id), `notify_club_gathering` (invite-only + auto-pin in club chat, 2026-08-17) | `club-gatherings-privacy.sql` |
...
| `public_club_invite` (anon-callable club preview for invite links, allowlisted) (2026-08-20) | `club-invite-public-preview.sql` |
...
| `club_directory` (next gathering = any non-cancelled future gathering, 2026-08-20) | `club-directory-gatherings.sql` |
| `vibe_attendees`, `vibe_confirmed_counts`, `vibe_people` (host roster lookup), `interests read` policy; attendee reads use `profiles`, not `public_profiles` (2026-08-20) | `vibe-attendees-rls.sql` |
