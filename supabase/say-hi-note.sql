-- ============================================================================
-- Flockie - Say-hi invite with a personal message (user feedback #1).
-- Replaces buddy_swipe with an 8-arg version (+p_note, default null - all
-- existing callers keep working). Run in the Supabase SQL editor.
-- ============================================================================

-- Say-hi invites can now carry a personal message (user feedback #1).
drop function if exists public.buddy_swipe(uuid, boolean, text);
drop function if exists public.buddy_swipe(uuid, boolean, text, text, text, text, timestamptz);
...
grant execute on function public.buddy_swipe(uuid, boolean, text, text, text, text, timestamptz, text) to authenticated;
